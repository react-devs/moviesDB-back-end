...
import '../style/watchlistBanner.css'

class watchlistBanner extends Component {
  render() {
    return (
      <div>
        <div className="movie-card">
          ...
          <div className="container">
            ...
            <a href={() => false}><img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/195612/hobbit_cover.jpg" alt="cover" className="cover" /></a>
            ...
            <div className="description">
              ...
              <div className="column2">
                ...
                <p>Bilbo Baggins is swept into a quest to reclaim the lost Dwarf Kingdom of Erebor from the fearsome dragon Smaug. Approached out of the blue by the wizard Gandalf the Grey, Bilbo finds himself joining a company of thirteen dwarves led by the legendary warrior, Thorin Oakenshield. Their journey will take them into the Wild; through... <a href={() => false}>read more</a></p>

                <div className="avatars">
                  <a href={() => false} data-tooltip="Person 1" data-placement="top">
                    <img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/195612/hobbit_avatar1.png" alt="avatar1" />
                  </a>

                  <a href={() => false} data-tooltip="Person 2" data-placement="top">
                    <img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/195612/hobbit_avatar2.png" alt="avatar2" />
                  </a>


                  <a href={() => false} data-tooltip="Person 3" data-placement="top">
